...
{
    public partial class Eduhome : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillLevel = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Photo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Date = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    Venure = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    Time = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    CategoryId = table.Column<int>(type: "int", maxLength: 150, nullable: false),
                    TagId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abouut = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Photo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Degree = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    Experience = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    Hobbies = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    ...
                    Numer = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    Skype = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    EventsId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
